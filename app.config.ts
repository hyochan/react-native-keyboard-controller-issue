...
export default ({config}: ConfigContext): ExpoConfig => ({
  ...config,
  name: 'keyboardcontrollerex',
  scheme: 'keyboardcontrollerex',
  slug: 'keyboardcontrollerex-slug',
  privacy: 'public',
  ...
  ios: {
    ...
    bundleIdentifier: 'io.keyboardcontrollerex',
  ...
  android: {
    ...
    package: 'io.keyboardcontrollerex',
    intentFilters: [
      {
        action: 'VIEW',
        autoVerify: true,
